...
#import sys
import os
installs = ['natsort','neuron','mpi4py','xlrd','pyNN','seaborn','lazyarray','neo','neuron']
def install_deps(i):
  '''
...
weight_gain_factors = {0.025:None,0.05:None,0.125:None,0.25:None,0.3:None,0.4:None,0.5:None,1.0:None,1.5:None,2.0:None,2.5:None,3.0:None}
